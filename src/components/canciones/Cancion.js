...
class CancionAction extends Component {
    ...
    startOrPauseRecording= (e) => {
      ...
      onStop= (id, blobObject) => {
        ...
        if (id==='audio1'){ this.setState({ archivo1:blobObject })}  
        if (id==='audio2'){ this.setState({ archivo2:blobObject })}  
        if (id==='audio3'){ this.setState({ archivo3:blobObject })}  
        let  rw='';
        // let global = this;
    ...
    guardarSonido=()=>{
        const {email, can1On, can2On, can3On, can4On, can5On, archivo1, archivo2, archivo3}=this.state
        let pista='';
        ...
        // a.click();
         if (this.state.email.length>0 && pista.length>0){
            ...
            xdata.append('audio1',this.state.archivo1);
...
crearblobfinal = () =>{
    let {blobURL1, blobURL4, archivo1, archivo2, archivo3, archivoab1, archivoab2, archivoab3}= this.state
    ...
    render() {
        const {transicion, retardo, mensajealerta, cancion, blobURL1, blobURL3, blobURL2, blobURL4, isRecording,isPaused,seconds} = this.state;
                ...
                {this.state.contenedorOn[0] === true &&
                    ...
                    <div className="contenedor1" id="p1">
                        ...
                        <div className="p1inicio">
                            ...
                            <img className="btn" src={f4} id="sig1" onClick={this.conteneaccion.bind(this,"0")}/>
                        </div>
                    </div>
                ...
                {this.state.contenedorOn[1] === true &&
                    <div className="contenedor2" id="p2">
                        ...
                        <div className="p2info">
                            ...
                            <div className="linea">
                                <div className="btn" >
                                    <img src={f9} id="btn1" onClick={this.cancionOn.bind(this,1)} />
                                </div>
                                <div className="btn" >
                                    <img src={f10} id="btn1" onClick={this.cancionOn.bind(this,2)} />
                                </div>
                                <div className="btn" >
                                    <img src={f11} id="btn1" onClick={this.cancionOn.bind(this,3)}/>
                                </div>
                                <div className="btn" >
                                    <img src={f12} id="btn1" onClick={this.cancionOn.bind(this,4)}/>
                                </div>
                                <div className="btn" >
                                    <img  id="btn1" onClick={this.cancionOn.bind(this,5)} src={f13}/>
                                </div>
                            </div>
                            <div className="linea1">
                                <audio className="output" id="output" ref="" controls="controls" src={cancion}></audio>
                            </div>
                            <img className="sig" src={f15} id="sig2" onClick={this.conteneaccion.bind(this,"1")}/>
                        </div>
                    </div>
                }
                ...
                {this.state.contenedorOn[2] === true &&
                    <div className="contenedor3" id="p3">
                        ...
                        <div className="p3info">
                            ...
                            <div className="linea">
                                <div className="btn" >
                                    <img src={f21} id="mic1" data-index='0' onClick={this.startOrPauseRecording}   />
                                </div>
                                <div className="btn">
                                    <img src={f22} id="stop1" data-index='0' disabled={!isRecording[0]} onClick={this.onComplete.bind(this,0)}/>                                
                                </div>
                                <div className="btn">
                                    <img src={f20} id="delete1" data-index='0' disabled={!this.state.botongrOn[0]} onClick={this.vaciarblob} />
                                </div>
                            </div>
                            <div className="linea1">
                            ...
                            <img className="sig" src={f19} id="sig3" onClick={this.conteneaccion.bind(this,"2")}/>
                        </div>
                    </div>
                }
                ...
                {this.state.contenedorOn[3] === true &&
                    <div className="contenedor4" id="p4">
                        ...
                        <div className="p4info">
                            ...
                            <div className="linea">
                                <div className="btn" >
                                    <img src={f21} id="mic2" data-index='1' onClick={this.startOrPauseRecording}   />
                                </div>
                                <div className="btn">
                                    <img src={f22} id="stop2" data-index='1' disabled={!isRecording[1]} onClick={this.onComplete.bind(this,1)}/>                                
                                </div>
                                <div className="btn">
                                    <img src={f20} id="delete2" data-index='1' disabled={!this.state.botongrOn[1]} onClick={this.vaciarblob} />
                                </div>
                            </div>
                            <div className="linea1">
                            ...
                            <img className="sig" src={f27} id="sig4" onClick={this.conteneaccion.bind(this,"3")}/>
                        </div>
                    </div>
                }
                ...
                {this.state.contenedorOn[4] === true &&
                    <div className="contenedor5" id="p5">
                        ...
                        <div className="p5info">
                            ...
                            <div className="linea">
                                <div className="btn" >
                                    <img src={f21} id="mic3" data-index='2' onClick={this.startOrPauseRecording}   />
                                </div>
                                <div className="btn">
                                    <img src={f22} id="stop3" data-index='2' disabled={!isRecording[2]} onClick={this.onComplete.bind(this,2)}/>                                
                                </div>
                                <div className="btn">
                                    <img src={f20} id="delete3" data-index='2' disabled={!this.state.botongrOn[2]} onClick={this.vaciarblob} />
                                </div>
                            </div>
                            <div className="linea1">
                            ...
                            <img className="sig" src={f32} id="sig5" onClick={this.conteneaccion.bind(this,"4")}/>
                        </div>
                    </div>
                }
                ...
                {this.state.contenedorOn[5] === true &&
                    ...
                    <div className="contenedor6" id="p6">
                            <div className="p6info">
                                ...
                                <div className="linea">
                                    <audio className="out0" id="out0" ref="" controls="controls" src={cancion}></audio>
                                    <audio className="out1" id="out1" ref="" controls="controls" src={blobURL1}></audio>
                                    <audio className="out2" id="out2" ref="" controls="controls" src={blobURL2}></audio>
                                    <audio className="out3" id="out3" ref="" controls="controls" src={blobURL3}></audio>
                                    {/* <button className="boton" onClick={this.crearblobfinal}>Reproducir Sonido</button>  */}
                                    <div className="btn">
                                       <img src={f36} id="repro" className="repro" onClick={this.crearblobfinal}/>                                
                                    </div>
                                    {/* <audio className="output" id="output" controls="" src="AUDIO5.mp3"></audio> */}
                                </div>
                                <div className="row">
                                    <img className="sig" src={f35} onClick={this.spineractivar.bind(this,"almacenar")}/>
                                </div>
                            </div>
                    </div>
                }
